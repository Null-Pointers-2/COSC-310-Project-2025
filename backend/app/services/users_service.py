...
def get_user_by_id(user_id: str, resources) -> dict | None:
    """Get user by ID."""
...
def get_user_profile(user_id: str, resources) -> UserProfile | None:
...
def get_user_dashboard(user_id: str, resources) -> UserDashboard | None:
