...
def get_rating_by_id(resources, rating_id: int) -> Optional[Rating]:
    """Get rating by ID."""
...
def update_rating(resources, rating_id: int, user_id: str, update_data: RatingUpdate) -> Optional[Rating]:
